...
class ControlLDM(LatentDiffusion):
    ...
    def get_input(self, batch, k, bs=None, *args, **kwargs):
        x, c,x0 = super().get_input(batch, self.first_stage_key, *args, **kwargs)
        ...
        if self.prior is not None:
            # [-1,1] -> [0, 255] 
            prior_hint = (batch['jpg']+1.) / 2 * 255. #batch['jpg'] -- depth/normal
        ...
        return x, dict(c_crossattn=[c], c_concat=[control], rgb = [x0],prior_out=[prior_z])
